...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ANYWHERE FITNESS’s mission: empower every individual to achieve their personal health goals through intelligent, adaptable, science-backed fitness and nutrition guidance." },
    ...
    <>
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-6 card-surface p-10">
            ...
            <p className="mt-5 text-xl leading-relaxed">
              To empower every individual to achieve their personal health goals through intelligent, adaptable, and science-backed fitness and nutrition guidance.
            </p>
          </div>
          <div className="lg:col-span-6 card-surface p-10">
            <p className="eyebrow">Vision</p>
            <p className="mt-5 text-xl leading-relaxed">
              Become the most trusted AI fitness companion in South Asia and beyond — making professional-grade health coaching accessible to everyone.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section className="!pt-0">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
            {[
              { t: "Overwhelming choice", d: "Generic plans that don’t fit your body, schedule or experience." },
              { t: "Disconnected nutrition", d: "Workouts and meals live in separate apps — adherence suffers." },
              { t: "No expert access", d: "Trainers and dietitians are unaffordable for most." },
              { t: "Static plans", d: "Nothing adapts when you miss workouts, plateau or change goals." },
            ].map((p) => (
      ...
      <Section className="!pt-0">
        <div className="card-surface p-10 md:p-14">
          ...
          <h2 className="display-lg mt-4 max-w-3xl">A $15B market growing 25% YoY in India alone.</h2>
          <p className="mt-5 text-muted-foreground max-w-2xl">
            Rising smartphone penetration, post-pandemic health awareness, and a massive underserved middle class hungry for affordable, personalised, culturally relevant fitness content.
          </p>
        </div>
      </Section>
      ...
      <Section className="!pt-0 text-center">
        ...
        <div className="mt-8 flex justify-center gap-3">
          <Link to="/pricing" className="btn-primary">Start free</Link>
          <Link to="/ai-coach" className="btn-ghost">See the engine</Link>
        </div>
      </Section>
    </>
  );
